            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot  snapshot:dataSnapshot.getChildren()){
                    ...
                    switch (type)
                    {
                        ...
                        case "Humidity":   imageUrl.add("https://www.shutterstock.com/image-vector/humidity-icon-flat-color-ladder-600w-1403387498.jpg");
                            sensorname.add("Humidity Alert");
                            message.add("Humidity just crossed the limit");
                            timestamp.add(time);
                            break;
