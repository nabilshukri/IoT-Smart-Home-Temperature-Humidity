...
public class RemoteControl3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remote_control3);
        ...
        increaseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentTemperature < 24) { // Maximum temperature limit
                    currentTemperature++;
        ...
        decreaseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentTemperature > 20) { // Minimum temperature limit
                    currentTemperature--;
                    updateTemperatureDisplay();
                    sendHttpRequest("temperature", String.valueOf(currentTemperature));
